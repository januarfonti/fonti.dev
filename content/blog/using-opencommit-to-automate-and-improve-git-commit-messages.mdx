...
summary: 'Explore how OpenCommit can transform your coding process by automating and enhancing your Git commit messages. Discover the benefits of this AI-powered tool and how to set it up in a breeze.'
---
...
<Image
  ...
  src={`/images/opencommit/opencommit-preview.png`}
  width={3840 / 3}
  height={2160 / 3}
/>
