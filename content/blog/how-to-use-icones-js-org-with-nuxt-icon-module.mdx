...
description: If you're looking for a library of open-source SVG icons for your Nuxt 3 project, you should check out https://icones.js.org/
...
<Image
  src="/images/blog/icones.gif"
  alt="Icones.js.org"
  width={800}
  height={624}
  className="shadow-lg rounded-lg my-4"
/>
