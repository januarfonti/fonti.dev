  ...
  return (
    <section>
      ...
      <div className="prose prose-neutral dark:prose-invert">
        ...
        <hr className="my-6 border-neutral-100 dark:border-neutral-800" />
        <h2 className="font-medium text-xl mb-1 tracking-tighter">PT. Dutakom Wibawa Putra (D~NET)</h2>
        <p className="text-neutral-600 dark:text-neutral-400 text-sm">
        ...
        <hr className="my-6 border-neutral-100 dark:border-neutral-800" />
        <h2 className="font-medium text-xl mb-1 tracking-tighter">CV. Bonanza Raya Indonesia</h2>
        <p className="text-neutral-600 dark:text-neutral-400 text-sm">
